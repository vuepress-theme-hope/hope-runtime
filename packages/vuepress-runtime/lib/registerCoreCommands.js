...
const { chalk } = require("@mr-hope/vuepress-shared-utils");
const envinfo = require("envinfo");

const { dev, build } = require("@mr-hope/vuepress-core");
const { path, logger, env } = require("@mr-hope/vuepress-shared-utils");
        ...
        .run(
          {
            ...
            npmPackages: [
              ...
              "@mr-hope/vuepress-theme-default",
            ],
          },
          {
            showNotFound: true,
