...
const { fs, path, logger, env } = require("@mr-hope/vuepress-shared-utils");
...
module.exports = function createBaseConfig(context, isServer) {
  ...
  function applyVuePipeline(rule) {
    rule.use("cache-loader").loader("cache-loader").options({
      cacheDirectory,
  ...
  mdRule
    .use("markdown-loader")
    .loader(require.resolve("@mr-hope/vuepress-markdown-loader"))
